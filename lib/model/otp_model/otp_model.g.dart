...
AccountTransferOTPBean _$AccountTransferOTPBeanFromJson(
    ...
    AccountTransferOTPBean(
      ...
      userModel: json['user_details'] == null
          ? null
          : OTPRequestModel.fromJson(
              json['user_details'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$AccountTransferOTPBeanToJson(
        AccountTransferOTPBean instance) =>
    <String, dynamic>{
      'status': instance.status,
      'oath_token': instance.oathToken,
      'corporate_hr_id': instance.corporateHrID,
