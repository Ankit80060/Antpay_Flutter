...
@JsonSerializable()
class AccountTransferOTPBean {
  AccountTransferOTPBean({
    this.status,
    this.oathToken,
    this.corporateHrID,
    this.msg,
  ...
  @JsonKey(name: 'user_details')
  OTPRequestModel? userModel;

  factory AccountTransferOTPBean.fromJson(Map<String, dynamic> json) =>
      _$AccountTransferOTPBeanFromJson(json);

  Map<String, dynamic> toJson() => _$AccountTransferOTPBeanToJson(this);
}
