...
class OfferDetailsByCategoryResponse {
  ...
  static List<OfferDetails>? _resultsFromJson(dynamic json) {
    if (json is List) {
      return json.map((e) => OfferDetails.fromJson(e as Map<String, dynamic>)).toList();
    }
    return [];
  }

  static dynamic _resultsToJson(List<OfferDetails>? details) {
