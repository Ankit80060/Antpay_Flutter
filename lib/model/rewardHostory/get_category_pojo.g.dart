...
part of 'get_category_pojo.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetCategoryPOJO _$GetCategoryPOJOFromJson(Map<String, dynamic> json) =>
    GetCategoryPOJO(
      status: (json['status'] as num?)?.toInt(),
      result: (json['results'] as List<dynamic>?)
          ?.map((e) => RewardResult.fromJson(e as Map<String, dynamic>))
          .toList(),
      msg: json['msg'] as String?,
    );

Map<String, dynamic> _$GetCategoryPOJOToJson(GetCategoryPOJO instance) =>
    <String, dynamic>{
...
GetOfferByCategoryResponse _$GetOfferByCategoryResponseFromJson(
        Map<String, dynamic> json) =>
    GetOfferByCategoryResponse(
      status: (json['status'] as num?)?.toInt(),
      offerModels: const ResultConverter().fromJson(json['results']),
      msg: json['msg'] as String?,
    );

Map<String, dynamic> _$GetOfferByCategoryResponseToJson(
        GetOfferByCategoryResponse instance) =>
    <String, dynamic>{
      'status': instance.status,
      'results': const ResultConverter().toJson(instance.offerModels),
      'msg': instance.msg,
    };

rewardOfferModel _$rewardOfferModelFromJson(Map<String, dynamic> json) =>
    rewardOfferModel(
      id: json['id'] as String?,
      ...
      ..bank =
          (json['bank'] as List<dynamic>?)?.map((e) => e as String).toList()
...
Map<String, dynamic> _$rewardOfferModelToJson(rewardOfferModel instance) =>
    <String, dynamic>{
      'id': instance.id,
