...
import 'package:antpay_lite/viewmodels/p2p_landing_controller/investment_verify_otp_controller.dart';
...
class InvestmentVerifyOTPScreen extends StatelessWidget {

  InvestmentVerifyOTPScreen({Key? key,}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(InvestmentOTPVerifyController());
    return MainScaffold(
        body: AbsorbPointer(
                                      ...
                                      : Center(
                                          child: SizedBox(
                                            ...
                                            child: CustomElevatedButton(
                                              bgColor: controller.timeDisplay.value ==
                                                      "Time Ended !!"
                                                  ? Colors.grey
                                              ...
                                              onPressed: () async {
                                                ...
                                                await controller.commanverifyOtp(
                                                  SessionManager()
                                                      .getMobile()
                                                      .toString(),
                                                );
