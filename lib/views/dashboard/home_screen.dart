...
import '../miniAcc/controller/virtual_card_controller .dart';
...
class HomeScreen extends StatelessWidget {
  ...
  final List<Map<String, String>> featurseimagepath = [
    {"image": "assets/images/recharges_db.png", "text": "Recharges"},
    {"image": "assets/images/life-insurance.png", "text": "Life\nInsurance"},
    {"image": "assets/images/motor-insurance.png", "text": "Car\nInsurance"},
    {
      "image": "assets/images/health-insurance.png",
      "text": "Health\nInsurance"
    },
    {"image": "assets/images/ic_loan_repay.png", "text": "Loan\nRepayment"},
    {"image": "assets/images/postpaid.png", "text": "PostPaid\nBill"},
    {"image": "assets/images/electricity.png", "text": "Electricity\nBill"},
  ];
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                            ...
                            switch (index) {
                              case 0:
                                if (homecontroller.kycResponseCode == "00") {
                                  if (homecontroller.kycAccountStatus
                                          .toString() !=
                                      "0") {
                                    CustomToast.show("Your Wallet Blocked");
                                    return;
                                  }
                                  if (homecontroller.kycName == "FULL KYC") {
                                    Get.to(() =>
                              ...
                              case 2:
                                if (homecontroller.kycResponseCode == "00") {
                                  ...
                                  if (homecontroller.kycName == "MIN KYC" || homecontroller.kycName == "FULL KYC") {
                                    SessionManager()
                ...
                Obx(() {
                  if (homecontroller.announcementList.isEmpty) {
                      ...
                      children: [
                        Expanded(
                          child: PageView.builder(
                            controller: homecontroller.pageController,
                            itemCount: homecontroller.pageData.length,
                            onPageChanged: (index) {
                              homecontroller.currentIndex.value = index;
                            },
                            itemBuilder: (context, pageIndex) {
                              final pageItems =
                                  homecontroller.pageData[pageIndex];
                              ...
                              return GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      final globalIndex = pageIndex * 6 + index;
                                      homecontroller
                                          .handelClickCard(globalIndex);
                                    },
                                    child: Column(
                                      mainAxisAlignment:
                  ...
                  child: Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: featurseimagepath.length,
                        scrollDirection: Axis.horizontal,
                        shrinkWrap: true,
                        itemBuilder: (BuildContext context, int index) {
                          final item = featurseimagepath[index];
                          return GestureDetector(
                            onTap: () {
                              homecontroller.handleTopFeatureClick(index);
                            },
                            child: Padding(
                              padding: const EdgeInsets.symmetric(
