import 'package:antpay_lite/viewmodels/recharge/mobile_recharge_plancontroller/sms_plan_controller.dart';
import 'package:antpay_lite/views/recharge/components/Mobile_PlanListTile2.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import '../../../../res/color_palette.dart';

class SMSPlanTabView extends StatelessWidget {
  const SMSPlanTabView({super.key});

  @override
  Widget build(BuildContext context) {
    final SMSPlanController controller = Get.put(SMSPlanController());
