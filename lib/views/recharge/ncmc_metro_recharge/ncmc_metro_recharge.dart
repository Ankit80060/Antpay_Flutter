...
import 'package:antpay_lite/viewmodels/recharge/ncmc_recharge_controller/ncmc_metro_recharge_controller.dart';
...
class NCMCMetroRechargeScreen extends StatelessWidget {
  NCMCMetroRechargeScreen({super.key});

  final NcmcRechargeController controller = Get.find<NcmcRechargeController>();
  ...
  Widget build(BuildContext context) {
    return MainScaffold(
      body: SingleChildScrollView(
        ...
        child: BillerFormFields(context),
      ),
    );
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(
                      controller.getServiceType() ?? "NCMC Recharge",
