      ...
      body: SafeArea(
            ...
            child: Column(
              ...
              children: [
                        ...
                        children: [
                          ...
                          Row(children: [
                            Expanded(
                                ...
                                child: CustomTextFieldwithoutlabel(
                                    controller: accountTranferController.searchController,
                                    hintText: "Search Payee",onChanged: (value) {
                                      accountTranferController.filterBeneficiaries(value);
                                    },)),
                              ...
                              child: CustomElevatedButton(
                                ...
                                onPressed: () {
                                 if (!SessionManager().getPayUMpinStatus()) {
                                   ...
                                   ),arguments: accountTranferController.beneficiaryResponse);
                                    }
                                  }
                          ...
                          Row(
                            children: List.generate(
                              ...
                              final type = accountTranferController.types[i ~/ 2];
                              return Expanded(
                                child: Obx(() => InkWell(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Radio<String>(activeColor: Colors.red,
                                            value: type,
                ...
                Obx((){ 
                  ...
                  if (accountTranferController.filteredBeneficiaryList.isEmpty) {
        return const Center(child: Text("No beneficiaries found"));
          ...
          return ListView.builder(
                  ...
                  itemCount: accountTranferController.filteredBeneficiaryList.length,
                  itemBuilder: (context, index) {
                 var  baneficiaryList=     accountTranferController.filteredBeneficiaryList[index];
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        ...
                        child: InkWell(
                          onTap: () {
                            SessionManager().addFromScreen("Account Transfer");
                            Get.to(()=>AccountTransferScreen(),arguments:baneficiaryList);
                          },
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                               ...
                               backgroundColor: avatarColors[index % avatarColors.length],
                                  child: Text(baneficiaryList.beneficiaryName![0].toUpperCase(),
                                      style: CustomStyles.white14500),
                                ),
                                const SizedBox(width: 10),
                                Expanded(flex: 2,
                                  child: Text(
                                    baneficiaryList.beneficiaryName!.toUpperCase()??'',
